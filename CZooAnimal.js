...
let a = 0;
class CZooAnimal {
    // Creo el constructor de la clase, que reciben (IdAnimal, name, cageNumber, IdTypeAnimal y weigh
  ...
  // Crear un array (vector) de instancias de la clase Persona
  const animales = [
...
//Hago un forEach que reccora todo el array de clases  
animales.forEach(animal => {
    ...
    // Tabla para Animales en la jaula 5 con peso menor a 3 kg
    ...
    // Animales tipo felino entre las jaulas 2 y 5
    ...
    // Animal en la jaula 4 con peso menor a 120
